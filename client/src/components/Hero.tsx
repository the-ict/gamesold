      ...
      <div className="w-[1200px] min-h-[calc(100vh-60px)] flex flex-col justify-between">
        <div className="mt-10 flex justify-between items-center h-full">
          <div>
            ...
            <button onClick={() => window.location.replace("/register")} className="p-2 border cursor-pointer bg-red-400 rounded-[10px] font-bold text-white px-5 py-3 mt-3">Sign up now</button>
          </div>
