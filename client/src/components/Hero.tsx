      ...
      <div className="w-[1200px] mt-[10px] relative">
        ...
        <div className="black absolute top-0 left-0 right-0 bottom-0 w-full h-full bg-black/80 flex items-center justify-center">
          <div className="flex items-center flex-col gap-5">
            ...
            <button onClick={() => window.location.replace("/login")} className="bg-red-500 px-5 transition hover:bg-red-600 py-2 w-[100px] cursor-pointer rounded-full ">Sign in</button>
          </div>
        </div>
